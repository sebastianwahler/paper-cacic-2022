...
Es interesante ver que éste individuo no es el que posee necesariamente la mayor cantidad de casos penales, pero es el más importante entre sus pares \textit{de su propia red social} de contactos con antecedentes relacionados.
%\vspace{-10pt}
\begin{table}
\centering
\resizebox{120pt}{!}{
