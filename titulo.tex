\title{
	Una Herramienta de Análisis y Visualización de Redes Sociales para la Identificación de Bandas Delictivas basada en PageRank y Detección de Comunidades
}

\titlerunning{PageRank y Community detection en Bandas Delictivas}
